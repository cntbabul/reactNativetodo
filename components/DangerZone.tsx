...
const DangerZone = () => {
    ...
    const clearCompletedTodos = useMutation(api.todos.clearCompletedTodos);
                ...
                { text: "Cancel", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert(
                                "Success",
                                `Successfully deleted ${result.deletedCount} completed todo${result.deletedCount === 1 ? "" : "s"}.`
                            );
                        } catch (error) {
        ...
        <LinearGradient colors={colors.gradients.surface} style={settingsStyles.section}>
            ...
            >
                <View style={settingsStyles.actionLeft}>
                    ...
                    <Text style={settingsStyles.actionTextDanger}>Clear Completed</Text>
                </View>
